#!/usr/bin/env python3
"""
OCR Evaluation Script for Llama-3.1-Nemotron-Nano-VL-8B-V1
Uses example_custom_dataset with the Nemotron model
"""
...
class NemotronOCREvaluator:
    def __init__(self, model_name: str = "nvidia/Llama-3.1-Nemotron-Nano-VL-8B-V1", 
        ...
        """
        Initialize Nemotron OCR Evaluator
    ...
    def predict_text(self, image_path: str) -> str:
        """
        Predict text from image using Nemotron model
    ...
    def save_detailed_results(self, results: Dict, output_file: str):
        ...
        with open(output_file, 'w', encoding='utf-8') as f:
            # Header
            f.write("="*100 + "\n")
            f.write("OCR Evaluation Results - Llama-3.1-Nemotron-Nano-VL-8B-V1\n")
            f.write("="*100 + "\n")
...
def main():
    parser = argparse.ArgumentParser(description='OCR Evaluation with Llama-3.1-Nemotron-Nano-VL-8B-V1')
    ...
    print("Starting OCR Evaluation with Llama-3.1-Nemotron-Nano-VL-8B-V1")
    ...
    evaluator = NemotronOCREvaluator(
    ...
    # Save detailed results to text file
    output_file = f"ocr_results_nemotron.txt"
